...
To make a video call, your app client has the following steps to take:
...
3. **Publish and subscribe to audio and video in the channel**
   You can use the `LocalTrack` and `RemoteTrack` objects to publish and subscirbe to tracks in the channel.
...
- The channel name: A string that identifies the RTC channel for the video call. 
